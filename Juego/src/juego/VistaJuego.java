...
public class VistaJuego {
    ...
    public void iniciarJuego() {
        ...
        while (continuarJugando) {
            ...
            while (intentos < 12 && !juegoGanado) {
                String entradaUsuario = JOptionPane.showInputDialog(null, "Introduce un número de 4 cifras diferentes:");
    ...
    public void mostrarEstadisticas() {
        ...
        boolean salir = false;
        while (salir != true) {
            String opcion = JOptionPane.showInputDialog(null, "BIENVENIDO\n\nPor favor seleccione una opción:\n1) Jugar\n2) Ver estadísticas\n3) Salir");
